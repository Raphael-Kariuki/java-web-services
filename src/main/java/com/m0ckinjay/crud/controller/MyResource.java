package com.m0ckinjay.crud.controller;

import com.m0ckinjay.crud.service.PersonService;
import com.m0ckinjay.crud.model.PersonModel;
import com.m0ckinjay.crud.service.DBUser;
import com.m0ckinjay.crud.model.Systemusers;
import com.m0ckinjay.crud.model.Patientdetails;
import com.m0ckinjay.crud.service.AllFormatters;
import com.m0ckinjay.crud.service.PatientDetailsJPAController;
...
import com.m0ckinjay.crud.service.passwordHashing;
...
//        System.out.println(""+ formDataMap.keySet());
        ...
        registerpatientDetails.setPmiddlename(formParameters.get("pMiddleName"));
        registerpatientDetails.setPlastname(formParameters.get("pLastName"));
        registerpatientDetails.setPdob(AllFormatters.stringDate(formParameters.get("pdob")));
        ...
        registerpatientDetails.setNokdob(AllFormatters.stringDate(formParameters.get("NOKdob")));
...
//        Patientdetails patientdetails = personService.getPatientDetailsByMRN(mrn);
        Patientdetails patientdetails = new PatientDetailsJPAController().getPatientdetails(mrn);
    ...
    public Response updateByMRN(@PathParam("mrn") String mrn,
        ...
        updatePatientdetails.setPmiddlename(formParameters.get("_pMiddleName"));
        updatePatientdetails.setPlastname(formParameters.get("_pLastName"));
        updatePatientdetails.setPdob(AllFormatters.stringDate(formParameters.get("_pdob")));
        ...
        updatePatientdetails.setNokdob(AllFormatters.stringDate(formParameters.get("_NOKdob")));
